...
import { Card, Row, Col, Button, Select, Space, Empty, Spin, message, Tooltip } from 'antd';
import { PlusOutlined, BgColorsOutlined, BulbFilled } from '@ant-design/icons';
...
const RoadmapPage = () => {
    ...
    const [timeRange, setTimeRange] = useState('6months'); // 6months, 12months, all
        ...
        <div className="roadmap-page">
            ...
            <div className="roadmap-header">
                <div>
                    ...
                    <p className="text-secondary">{currentProject.name}</p>
                </div>
                <Space>
